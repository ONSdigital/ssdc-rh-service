...
public class CollectionExerciseRepository {
  ...
  public void writeCollectionExerciseUpdate(final CollectionExerciseUpdateDTO collectionExerciseUpdateDTO) {
  ...
  public Optional<CollectionExerciseUpdateDTO> readCollectionExerciseUpdate(String collectionExerciseId) {
    return rhFirestoreClient.retrieveObject(CollectionExerciseUpdateDTO.class, collectionExerciseSchemaName, collectionExerciseId);
  }
}
