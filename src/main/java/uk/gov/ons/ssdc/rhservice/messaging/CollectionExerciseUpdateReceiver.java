...
public class CollectionExerciseUpdateReceiver {
    ...
    public CollectionExerciseUpdateReceiver(CollectionExerciseRepository collectionExerciseRepository) {
    ...
    public void receiveMessage(Message<byte[]> message) {
        ...
        CollectionExerciseUpdateDTO collectionExerciseUpdateDTO = event.getPayload().getCollectionExerciseUpdateDTO();
