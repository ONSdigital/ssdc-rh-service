...
// import static uk.gov.ons.ssdc.rhservice.testutils.MessageConstructor.constructMessage;
// import static uk.gov.ons.ssdc.rhservice.testutils.TestConstants.TEST_CORRELATION_ID;
// import static uk.gov.ons.ssdc.rhservice.testutils.TestConstants.TEST_ORIGINATING_USER;
// import static uk.gov.ons.ssdc.rhservice.utils.Constants.OUTBOUND_EVENT_SCHEMA_VERSION;
//
...
// import uk.gov.ons.ssdc.rhservice.logging.EventLogger;
// import uk.gov.ons.ssdc.rhservice.model.dto.DeactivateUacDTO;
...
//    when(uacService.saveAndEmitUacUpdateEvent(any(UacQidLink.class), any(UUID.class),
// anyString()))
...
//            uacQidLinkArgumentCaptor.capture(), eq(TEST_CORRELATION_ID),
