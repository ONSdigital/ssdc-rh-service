...
class EqLaunchEndpointIT {
    ...
    @Test
    void testEqLaunchUrlSuccessfullyReturned() throws UnirestException, JsonProcessingException, InterruptedException {

        try (QueueSpy<EventDTO> outboundCaseQueueSpy =
                     pubsubTestHelper.sharedProjectListen(OUTBOUND_AUTHENTICATION_SUBSCRIPTION, EventDTO.class)) {
