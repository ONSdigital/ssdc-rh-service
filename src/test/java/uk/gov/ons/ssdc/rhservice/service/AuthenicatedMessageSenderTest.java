...
class AuthenicatedMessageSenderTest {
    ...
    @InjectMocks
    AuthenicatedMessageSender underTest;
    ...
    public void testMessageSent() {
        ...
        EventDTO eventDTO = eventArgCaptor.getValue();
        ...
        assertThat(eventHeaderDTO.getDateTime()).isCloseTo(OffsetDateTime.now(), within(5, ChronoUnit.SECONDS));
